...
function Fishing_and_Banking(spotType)
    ...
    if Inventory:IsFull() then
        ...
        while API.Read_LoopyLoop and (API.SystemTime() - bankTimer) < 30000 do
            ...
            if not Inventory:Contains("Raw trout") and Inventory:Contains("Feathers") then
                break
            end
        ...
        if API.SystemTime() - bankTimer > 30000 then
            API.logWarn("Unable to deposit at the bank chest!")
...
do-----------------------------------------------------------------------------------
    Fishing_and_Banking(SPOTS.TROUT)
end----------------------------------------------------------------------------------
